...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/vehicle-count', icon: Car, labelKey: 'sidebar.vehicleCount' },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/pricing-matrix',  icon: IndianRupee,  labelKey: 'sidebar.pricing' },
      { to: '/agents',          icon: Handshake,    labelKey: 'sidebar.agents' },
    ],
  },
  {
