  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // `max-w-md` is the unstyled default. Callers that pass `max-w-XXX`
          // (e.g. `max-w-2xl`) will correctly override it via tailwind-merge
          // because both classes are in the same `max-w-*` family.
