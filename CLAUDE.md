...
**Telegram delivery:** Four templates seeded by `seed_default_templates()` — `anpr_entry`, `anpr_exit`, `anpr_unknown_plate`, `anpr_camera_down`. Owner picks events via existing Recipients tab on `/notifications`.
