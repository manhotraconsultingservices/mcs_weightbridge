...
class CompanyResponse(BaseModel):
    ...
    email: str | None = None
    website: str | None = None
    # Bank details — were previously omitted here, so GET /company stripped them and
    # the Settings → Bank Details form loaded blank even though the DB had the values.
    bank_name: str | None = None
    bank_account_no: str | None = None
    bank_ifsc: str | None = None
    bank_branch: str | None = None
