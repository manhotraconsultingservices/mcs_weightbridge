...
def get_column_migrations() -> list[str]:
    ...
    return [
        ...
        "ALTER TABLE tally_config ADD COLUMN IF NOT EXISTS godown_name VARCHAR(100)",
        "ALTER TABLE tally_config ADD COLUMN IF NOT EXISTS use_batches BOOLEAN NOT NULL DEFAULT FALSE",
        "ALTER TABLE products ADD COLUMN IF NOT EXISTS tally_synced BOOLEAN NOT NULL DEFAULT FALSE",
        "ALTER TABLE products ADD COLUMN IF NOT EXISTS tally_sync_at TIMESTAMPTZ",
